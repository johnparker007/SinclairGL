...
namespace Speculator.Core
{
    public class ZxFileIo
    {
        ...
        private void LoadFileInternal(FileInfo fileInfo)
        {
            ...
            {
// JP DISABLING AS NO ZIP EXTRACTOR LIB FOR NOW
                //case ".zip":
                //    {
        ...
        private void LoadZ80(FileInfo file)
        {
            ...
            while (stream.Position < stream.Length)
            {
                ...
                {
                    case 0:
                        m_cpu.MainMemory.LoadData(data, 0x0000);
                        break;
                    case 4:
                        m_cpu.MainMemory.LoadData(data, 0x8000);
                        break;
                    case 5:
                        m_cpu.MainMemory.LoadData(data, 0xC000);
                        break;
                    case 8:
                        m_cpu.MainMemory.LoadData(data, 0x4000);
                        break;
