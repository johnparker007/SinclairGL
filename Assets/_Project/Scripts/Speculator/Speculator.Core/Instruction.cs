...
namespace Speculator.Core
{
    public class Instruction
    {
        ...
        /// </summary>
        // JP TO THIS NEEDS TO BE PORTED BACK TO A MORE BASIC IMPLEMENTATION:         
        //        public Func<Memory, Registers, Alu, ushort, int> Run { get; internal init; }
        public Func<Memory, Registers, Alu, ushort, int> Run 
        { 
            get;
            internal set; // JP CHANGED TO 'SET' JUST SO IT'D COMPILE - NEEDS A REWRITE?
        }
